...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, name: $name, lastname: $lastname, edad: $edad, password: $password, vpassword: $vpassword, peso: $peso, altura: $altura, termsOk: $termsOk)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.altura, altura) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(altura),
